...
EOD;
        ...
        Yii::app()->clientScript->registerScriptFile($this->assetsDir . '/noty/js/noty/jquery.noty.js', CClientScript::POS_END);
        Yii::app()->clientScript->registerScriptFile($this->assetsDir . '/noty/js/noty/layouts/center.js', CClientScript::POS_END);
        Yii::app()->clientScript->registerScriptFile($this->assetsDir . '/noty/js/noty/themes/default.js', CClientScript::POS_END);
        //js spinner
        Yii::app()->clientScript->registerScriptFile($this->assetsDir . '/spin.min.js', CClientScript::POS_END);
        //fancybox
       Yii::app()->clientScript->registerScriptFile($this->assetsDir . '/fancybox2/jquery.fancybox.js', CClientScript::POS_END);
        Yii::app()->clientScript->registerCssFile($this->assetsDir . '/fancybox2/jquery.fancybox.css');

        Yii::app()->clientScript->registerScriptFile($this->assetsDir. '/json2/json2.js');

        Yii::app()->clientScript->registerCoreScript('yiiactiveform');

        // jquery.form.js plugin http://malsup.com/jquery/form/
        Yii::app()->clientScript->registerScriptFile($this->assetsDir . '/ajaxform/jquery.form.js', CClientScript::POS_END);
        Yii::app()->clientScript->registerScriptFile($this->assetsDir . '/ajaxform/form.js', CClientScript::POS_END);
        //jstree
        Yii::app()->clientScript->registerScriptFile($this->assetsDir . '/jstree/jquery.jstree.js', CClientScript::POS_END);
        Yii::app()->clientScript->registerScriptFile($this->assetsDir . '/jstree.behavior.js', CClientScript::POS_END);
    }

...
var updateDialog = {
  ...
  init : function(){
    // Set dialog
    this.dialog = jQuery( '#update-dialog' );
    ...
    jQuery( '.update-dialog-content input[type=submit]' )
      .on( 'click', function( e ){
        // Prevent default action
        e.preventDefault();
        
        // Submit form data together with clicked button name
        updateDialog.submit( jQuery( this ).attr( 'name' ) );
      });
    
    // Attach a handler for all cancel buttons in dialog content
    jQuery( '.update-dialog-content .update-dialog-cancel-button' )
      .on( 'click', function( e ){
        // Prevent default action
        e.preventDefault();
  ...
  successCallback : function(){
    ...
    jQuery( '.grid-view' ).each( function(){
      $.fn.yiiGridView.update( jQuery( this ).attr( 'id' ) );
    });
    
    // Update all listviews
    jQuery( '.list-view' ).each( function(){
      $.fn.yiiListView.update( jQuery( this ).attr( 'id' ) );
    });
...
function updateDialogOpen( e ){
  ...
  updateDialog.title = jQuery( this ).data( 'update-dialog-title' );
  ...
  // Open update dialog
  updateDialog.open( jQuery( this ).attr( 'href' ) );
}